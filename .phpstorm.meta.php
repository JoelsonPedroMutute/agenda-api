...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\agenda-api\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\agenda-api\\public\\storage','l5-swagger.default','l5-swagger.documentations.default.api.title',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','appointments.index',
'appointments.store','appointments.show','appointments.update','appointments.destroy','reminders.index',
'reminders.store','reminders.show','reminders.update','reminders.destroy','password.email',
'password.update','password.reset','register',
...
'FRONTEND_URL','L5_SWAGGER_CONST_HOST','SANCTUM_STATEFUL_DOMAINS','APP_LOCALE','APP_FALLBACK_LOCALE',
